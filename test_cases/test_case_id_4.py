...
class TestCaseId4(unittest.TestCase):
    ...
    def test_case_id_4(self):
        ...
        add_player_page.select_leg(AddPlayerPage.right_leg_xpath)
        add_player_page.submit()
        add_player_page.check_field_alert()
        self.driver.save_screenshot("../screenshots/test_case_id_4.png")
