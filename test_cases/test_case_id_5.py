...
class TestCaseId5(unittest.TestCase):
    ...
    def test_case_id_5(self):
        ...
        add_player_page.type_age("1010100000")
        ...
        add_player_page.wait_visibility_of_element_located(AddPlayerPage.cannot_add_player_contains_xpath)
        self.driver.save_screenshot("../screenshots/test_case_id_5.png")
